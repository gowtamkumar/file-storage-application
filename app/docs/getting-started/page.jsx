              ...
              >
                ...
                >
                  ...
                  <Paragraph style={{ fontSize: '1.125rem', color: '#8c8c8c', marginBottom: '32px' }}>
                    Welcome! This guide will help you get up and running with your file storage account in just a few minutes.
                  </Paragraph>
                  ...
                  {/* Steps Overview */}
                  <Title level={2} style={{ marginTop: '40px', marginBottom: '24px' }}>
                    Overview
                  </Title>
                  <Steps
                    direction="vertical"
                  ...
                  <div id="create-account">
                    ...
                    <Card style={{ background: '#f9fafb', border: '1px solid #e5e7eb', marginBottom: '24px' }}>
                      <Timeline
                        items={[
                          {
                            children: (
                              <>
                                <Text strong>Navigate to the registration page</Text>
                                <br />
                                <Text type="secondary">
                                  Visit <Link href="/register">/register</Link> or click "Start for Free" on the homepage
                                </Text>
                              </>
                            ),
                          },
                            ...
                            children: (
                              <>
                                ...
                                <Text type="secondary">
                                  ...
                                  <br />• Role (select "User" for regular account or "Admin" for administrative access)
                                </Text>
                              </>
                            ),
                          },
                          {
                            children: (
                              <>
                                ...
                                <br />
                                <Text type="secondary">Your account will be created instantly</Text>
                              </>
                            ),
                          },
                        ]}
                  ...
                  <div id="log-in">
                    <Title level={2} style={{ marginTop: '48px', marginBottom: '24px' }}>
                      <LoginOutlined style={{ marginRight: '12px', color: '#52c41a' }} />
                          ...
                          },
                          {
                            children: (
                              <>
                                ...
                                <br />
                                <Text type="secondary">
                                  • Regular users → <Link href="/user">/user</Link>
                                  <br />• Administrators → <Link href="/dashboard">/dashboard</Link>
                                </Text>
                              </>
                            ),
                          },
                  ...
                  <div id="upload-file">
                    <Title level={2} style={{ marginTop: '48px', marginBottom: '24px' }}>
                      <CloudUploadOutlined style={{ marginRight: '12px', color: '#722ed1' }} />
                      Step 3: Upload Your First File
                    </Title>
                    <Card style={{ background: '#f9fafb', border: '1px solid #e5e7eb', marginBottom: '24px' }}>
                      <Paragraph>
                        <Text strong>From your dashboard, you have two ways to upload files:</Text>
                      </Paragraph>
                        ...
                        <Col xs={24} md={12}>
                          ...
                          >
                            <ol style={{ paddingLeft: '20px', margin: 0 }}>
                              <li>Click the "Upload Files" button in the upload card</li>
                  ...
                  <div id="dashboard-overview">
                    ...
                    <Row gutter={[16, 16]}>
                      <Col xs={24} md={8}>
                        ...
                        >
                          <CheckCircleOutlined style={{ fontSize: '32px', color: '#1890ff', marginBottom: '12px' }} />
                          <Title level={4}>File Management</Title>
                          <Paragraph style={{ margin: 0, color: '#8c8c8c' }}>
                            View all your uploaded files in a table with filename, size, upload date, and actions.
                          </Paragraph>
                        </Card>
                      </Col>
                      <Col xs={24} md={8}>
                        ...
                        >
                          ...
                          <Paragraph style={{ margin: 0, color: '#8c8c8c' }}>
                            Each file gets a unique, shareable URL. Click "Copy" to copy the link and share it anywhere.
                          </Paragraph>
                        </Card>
                      </Col>
                      <Col xs={24} md={8}>
                        <Card
                          ...
                          bodyStyle={{ padding: '24px' }}
                        >
                          <CheckCircleOutlined style={{ fontSize: '32px', color: '#722ed1', marginBottom: '12px' }} />
                          <Title level={4}>Storage Stats</Title>
                          <Paragraph style={{ margin: 0, color: '#8c8c8c' }}>
                            Monitor your storage usage and see how many files you've uploaded.
                          </Paragraph>
                        </Card>
                      </Col>
                    </Row>
                  ...
                  <div id="api-key">
                    <Title level={2} style={{ marginTop: '48px', marginBottom: '24px' }}>
                      <KeyOutlined style={{ marginRight: '12px', color: '#fa8c16' }} />
                      Optional: Generate API Key
                    </Title>
                    <Paragraph>
                      If you want to integrate file uploads into your own applications, you can generate an API key.
                    </Paragraph>
                    <Card style={{ background: '#f9fafb', border: '1px solid #e5e7eb', marginBottom: '24px' }}>
                      <Timeline
                        items={[
                          {
                            children: (
                              <>
                                <Text strong>Navigate to the API Key section</Text>
                                <br />
                                <Text type="secondary">Found at the top of your user dashboard</Text>
                              </>
                            ),
                          },
                          {
                            children: (
                              <>
                                ...
                                <br />
                                <Text type="secondary">A new key will be created (this invalidates any previous key)</Text>
                              </>
                            ),
                          },
                          {
                            children: (
                              <>
                                ...
                                <br />
                                <Text type="secondary">Keep it secure - treat it like a password!</Text>
                              </>
                            ),
                          },
                          {
                            children: (
                              <>
                                ...
                                <br />
                                <Text type="secondary">
                                  Check the <Link href="/docs/api">API Documentation</Link> for integration examples
                                </Text>
                              </>
                            ),
                          },
                      ...
                      <Col xs={24} sm={12}>
                        <Link href="/docs/user-guide">
                          <Card hoverable style={{ height: '100%' }}>
                            ...
                            <Paragraph style={{ margin: 0, color: '#8c8c8c' }}>
                              Learn advanced file management features and sharing options
                            </Paragraph>
                          </Card>
                        </Link>
                      </Col>
                      <Col xs={24} sm={12}>
                        <Link href="/docs/plans">
                          <Card hoverable style={{ height: '100%' }}>
                            ...
                            <Paragraph style={{ margin: 0, color: '#8c8c8c' }}>
                              See subscription options and upgrade for more storage
                            </Paragraph>
                          </Card>
                        </Link>
                      </Col>
