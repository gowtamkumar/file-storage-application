            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <Paragraph className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                  Experience lightning-fast uploads, military-grade encryption,
                  and seamless sharing. The workspace built for the future of
                  work.
                </Paragraph>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <Paragraph className="text-xl text-gray-500 max-w-2xl mx-auto">
                Powerful features to help you manage your digital assets with
                confidence.
              </Paragraph>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <FeatureCard
                icon={
                  <CheckCircleOutlined className="text-4xl text-orange-500" />
                }
            ...
            <Collapse ghost size="large" expandIconPlacement="end">
              ...
              >
                <p className="text-gray-600">
                  Yes! Our free plan includes 5GB of storage and all core
              ...
              >
                <p className="text-gray-600">
                  We use AES-256 encryption for files at rest and TLS for data
                  in transit. Your data is safe with us.
                </p>
              </Panel>
              <Panel
                header={
              ...
              >
                <p className="text-gray-600">
                  Yes, we offer a comprehensive REST API for developers to
                  integrate storage into their applications.
                </p>
              </Panel>
            </Collapse>
          </div>
        ...
        <section className="py-24 bg-blue-600 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-blue-100 mb-10">
              Join thousands of developers and teams who trust us with their
...
function TestimonialCard({ name, role, content, delay }) {
  return (
    ...
    >
      ...
      <Paragraph className="text-gray-600 text-lg italic mb-6">
        "{content}"
      </Paragraph>
      <div className="flex items-center gap-4">
        <Avatar
          size="large"
          style={{ backgroundColor: "#bfdbfe", color: "#2563eb" }}
        >
          {name[0]}
        </Avatar>
        <div>
